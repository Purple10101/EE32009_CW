...
class RecordingInf:
    ...
    def __init__(self, datasets, dataset_ids):
        ...
        model_paths = [
            ...
            "src/nn/ind_mdl/event_detection/models/D3/20251114_neuron_event_det_cnn.pt",
            "src/nn/ind_mdl/event_detection/models/D4/20251114_neuron_event_det_cnn.pt",
            "src/nn/ind_mdl/event_detection/models/D5/20251114_neuron_event_det_cnn.pt",
        ...
        model_paths = [
            "src/nn/ind_mdl/neuron_classifcation/models/D2/20251114_cls_cnn.pt",
            "src/nn/ind_mdl/neuron_classifcation/models/D3/20251114_cls_cnn.pt",
            "src/nn/ind_mdl/neuron_classifcation/models/D4/20251114_cls_cnn.pt",
            "src/nn/ind_mdl/neuron_classifcation/models/D5/20251114_cls_cnn.pt",
    ...
    def cls_inf(self, dataset, model):
        ...
        model.eval()
        inference_dataset = InferenceDataCls(dataset, self.index_lst)
        model_preds = []
    ...
    def export_mat(self, data, dataset_id):
        ...
        savemat(f"src/nn/ind_mdl/seq/20251114_seq/outputs/vis/{dataset_id}_vis.mat", export_data)
        export_data_sub = {
            "Index": self.index_lst,
            "Class" : self.cls_lst
        }
        savemat(f"src/nn/ind_mdl/seq/20251114_seq/outputs/sub/{dataset_id}.mat", export_data_sub)
