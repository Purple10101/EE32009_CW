...
class RecordingInf:
    ...
    def __init__(self, datasets, dataset_ids):
        ...
        model_paths = [
            ...
            "src/nn/ind_mdl/event_detection/models/D3/20251120_neuron_event_det_cnn.pt",
            "src/nn/ind_mdl/event_detection/models/D4/20251120_neuron_event_det_cnn.pt",
    ...
    def event_det_inf(self, dataset, model, dataset_id):
        ...
        if dataset_id == 5:
            preds = nonmax_rejection(final_probs, threshold=self.threshold, refractory=10)
        elif dataset_id == 6:
            preds = nonmax_rejection(final_probs, threshold=0.85, refractory=10)
        else:
